  ...
  return (
    <section className="glass-panel p-5 sm:p-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          <div className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-600 dark:text-slate-400">Market leaders</div>
          <h2 className="mt-1 text-xl font-semibold text-slate-900 dark:text-white">Top firmy podľa známky (2024)</h2>
          <p className="mt-1 max-w-4xl text-sm text-slate-700 dark:text-slate-300">
            Výber z 25 % najväčších spoločností (tržby + majetok), zoradené podľa známky, Kralicek Quick-Test skóre a veľkosti firmy.
          </p>
        </div>
      </div>

      <div className="mt-4 overflow-hidden rounded-2xl border border-slate-900/10 dark:border-white/10">
