    ...
    <section className="panel p-4 sm:p-5">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <h2 className="mt-1 text-lg font-semibold text-white sm:text-xl">Top firmy podľa známky (2024)</h2>
          <p className="mt-1 text-sm text-slate-300/80">
            Výber z 25% najväčších firiem (tržby + majetok), zoradené podľa známky, skóre Kralicek Quick-Test a veľkosti.
          </p>
        </div>
      </div>
