        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.35fr_1fr] lg:items-end">
          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-[#1d2d49]/60 to-[#050b19] p-5">
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-200">
              <li className="rounded-xl border border-white/10 bg-white/5 px-3 py-2">Vyhľadávanie spoločností podľa IČO alebo názvu</li>
              <li className="rounded-xl border border-white/10 bg-white/5 px-3 py-2">Sektorové porovnanie dôležitých ukazovateľov</li>
              <li className="rounded-xl border border-white/10 bg-white/5 px-3 py-2">Hodnotenie firiem na základe histórie</li>
            </ul>
          </div>
        </div>
      </section>
